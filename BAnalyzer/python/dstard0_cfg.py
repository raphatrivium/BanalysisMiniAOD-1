...
#'root://cmsxrootd.fnal.gov//store/data/Run2018A/ParkingBPH1/MINIAOD/14May2018-v1/30000/0CE8C0BD-345A-E811-81FC-484D7E8DF0E0.root'
...
process.analysis = cms.EDAnalyzer('DstarD0TTree',
    ...
    PathName = cms.untracked.string("HLT_Mu9_IP6_part0_v1"),
	 #PathName = cms.untracked.string("HLT_Mu7_IP4_part0_v2"),
